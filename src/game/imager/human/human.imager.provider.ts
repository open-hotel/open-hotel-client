...
export class HumanImager {
  ...
  get figuremap() {
    return this.getJSON('figuremap')
  }

  get figuredata() {
    return this.getJSON('figuredata')
  }

  get draworder() {
    return this.getJSON('draworder')
  }

  get partsets() {
    return this.getJSON('partsets')
  }

  get avatarActions(): { state; precedence } {
    return this.getJSON('avatarActions')
  }

  get geometry() {
    return this.getJSON('geometry')
  }

  get animations() {
    return this.getJSON('animations')
  }

  get effectmap() {
    return this.getJSON('effectmap')
  }
