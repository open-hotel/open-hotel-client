...
//   constructor(private readonly loader: Loader, private readonly appProvider: ApplicationProvider) {}
...
//     ].map(part => ({
//       name: part.lib,
//       url: `${part.lib}/${part.lib}.json`,
//       parsers: ['spritesheet']
//     }))
//     return this.loader.add(files)
//   }
...
//     const fxParts = Object.keys(parts)
...
//     return this.appProvider.app.renderer.generateTexture(imageContainer, PIXI.SCALE_MODES.NEAREST, 1, geometry)
//   }
...
//         const animations = await this.loader.add(resourceId, `${lib}/animations.json`)

//         Object.assign(this.animations, animations.json)
//       }
...
//         const [fxResource, fxAnimations] = await this.loader.add([
//           {
//             name: fxLib,
//             url: `${fxLib}/${fxLib}.json`,
//           },
//           {
//             name: `${fxLib}/animations`,
//             url: `${fxLib}/animations.json`,
//           },
//         ])

//         const animation = fxAnimations.json[animationId]
